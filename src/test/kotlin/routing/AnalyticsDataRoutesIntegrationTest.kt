...
class AnalyticsDataRoutesIntegrationTest {
    ...
    @Test
    fun `GET analyticsData - should return 200 with empty list when no data exists`() = testApplication {
        // Arrange
        val fakeRepo = FakeAnalyticsDataRepository()
    ...
    @Test
    fun `GET analyticsData by activityId - should return 200 with analytics data for activity`() = testApplication {
        // Arrange
        val fakeRepo = FakeAnalyticsDataRepository()
        ...
        // Act
        val response = client.get("/analyticsData/1")
